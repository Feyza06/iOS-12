...
/** (tsType: MessageWithRelations, schemaOptions: { includeRelations: true }) */
public struct MessageWithRelations: Codable, JSONEncodable, Hashable {
