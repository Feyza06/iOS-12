...
public struct PostFilter1: Codable, JSONEncodable, Hashable {
    ...
    public var fields: PostFields?
    public var include: [PostIncludeFilterInner]?

    public init(offset: Int? = nil, limit: Int? = nil, skip: Int? = nil, order: LikeFilterOrder? = nil, _where: [String: AnyCodable]? = nil, fields: PostFields? = nil, include: [PostIncludeFilterInner]? = nil) {
        self.offset = offset
        self.limit = limit
        self.skip = skip
        self.order = order
