...
public struct LikeFilter1: Codable, JSONEncodable, Hashable {
    ...
    public var fields: LikeFields?

    public init(offset: Int? = nil, limit: Int? = nil, skip: Int? = nil, order: LikeFilterOrder? = nil, _where: [String: AnyCodable]? = nil, fields: LikeFields? = nil) {
        self.offset = offset
        self.limit = limit
        self.skip = skip
        self.order = order
