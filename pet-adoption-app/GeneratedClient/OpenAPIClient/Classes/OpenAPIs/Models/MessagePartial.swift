...
/** (tsType: Partial&lt;Message&gt;, schemaOptions: { partial: true }) */
public struct MessagePartial: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Double? = nil, senderId: String? = nil, recipientId: String? = nil, postId: String? = nil, content: String? = nil, createdAt: Date? = nil) {
        self.id = id
