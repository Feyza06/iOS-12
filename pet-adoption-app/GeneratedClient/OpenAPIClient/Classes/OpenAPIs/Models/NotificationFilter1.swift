...
public struct NotificationFilter1: Codable, JSONEncodable, Hashable {
    ...
    public init(offset: Int? = nil, limit: Int? = nil, skip: Int? = nil, order: LikeFilterOrder? = nil, _where: [String: AnyCodable]? = nil, fields: NotificationFields? = nil) {
        self.offset = offset
        self.limit = limit
        self.skip = skip
        self.order = order
