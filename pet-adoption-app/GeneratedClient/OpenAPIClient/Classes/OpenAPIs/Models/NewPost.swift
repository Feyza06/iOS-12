...
/** (tsType: Omit&lt;Post, &#39;id&#39;&gt;, schemaOptions: { title: &#39;NewPost&#39;, exclude: [ &#39;id&#39; ] }) */
public struct NewPost: Codable, JSONEncodable, Hashable {
    ...
    public init(petName: String, petType: String, petBreed: String, gender: String, photo: Bool, description: String, preferredHome: String, status: String, createdAt: Date, userId: String? = nil) {
