...
public struct Post: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Double? = nil, petName: String, petType: String, petBreed: String, gender: String, photo: Bool, description: String, preferredHome: String, status: String, createdAt: Date, userId: String? = nil) {
        self.id = id
