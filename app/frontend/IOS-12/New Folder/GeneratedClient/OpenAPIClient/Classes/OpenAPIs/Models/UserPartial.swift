...
public struct UserPartial: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Double? = nil, username: String? = nil, email: String? = nil, password: String? = nil, firstName: String? = nil, lastName: String? = nil, photo: String? = nil) {
        self.id = id
