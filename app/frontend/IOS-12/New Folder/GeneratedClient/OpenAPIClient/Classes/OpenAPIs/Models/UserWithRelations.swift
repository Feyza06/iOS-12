...
public struct UserWithRelations: Codable, JSONEncodable, Hashable {
    ...
    public var post: [PostWithRelations]?

    public init(id: Double? = nil, username: String, email: String, password: String, firstName: String, lastName: String? = nil, photo: String? = nil, post: [PostWithRelations]? = nil) {
        self.id = id
    ...
    public init(from decoder: Decoder) throws {
        ...
        post = try container.decodeIfPresent([PostWithRelations].self, forKey: .post)
        ...
        nonAdditionalPropertyKeys.insert("post")
