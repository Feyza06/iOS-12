...
/** (tsType: Partial&lt;Like&gt;, schemaOptions: { partial: true }) */
public struct LikePartial: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Double? = nil, userId: String? = nil, postId: String? = nil, createdAt: Date? = nil) {
        self.id = id
        self.userId = userId
        self.postId = postId
