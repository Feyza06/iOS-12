...
public struct LikeFilter: Codable, JSONEncodable, Hashable {
    ...
    public init(offset: Int? = nil, limit: Int? = nil, skip: Int? = nil, order: LikeFilterOrder? = nil, fields: LikeFields? = nil) {
        self.offset = offset
        self.limit = limit
        self.skip = skip
        self.order = order
