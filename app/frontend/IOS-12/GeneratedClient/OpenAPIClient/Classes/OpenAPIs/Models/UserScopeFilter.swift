...
public struct UserScopeFilter: Codable, JSONEncodable, Hashable {
    ...
    public var fields: PostScopeFilterFields?
    public var include: [[String: AnyCodable]]?

    public init(offset: Int? = nil, limit: Int? = nil, skip: Int? = nil, order: LikeFilterOrder? = nil, _where: [String: AnyCodable]? = nil, fields: PostScopeFilterFields? = nil, include: [[String: AnyCodable]]? = nil) {
        self.offset = offset
        self.limit = limit
        self.skip = skip
        self.order = order
